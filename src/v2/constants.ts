...
export const DEFAULT_CAPTURE_INTERACTIVE: Required<CaptureInteractiveConfig> = { timeout: 5_000, debounceLongTasksBy: 500, skipDebounceForLongEventsShorterThan: 0 }
...
export const DEFAULT_OBSERVED_ENTRY_TYPES = ['mark', 'measure', 'resource', 'element', 'visibility-state']

// see https://developer.chrome.com/docs/web-platform/long-animation-frames
export const BLOCKING_TASK_ENTRY_TYPES: readonly [string, string] = ['long-animation-frame', 'longtask'];/** when present on 'detail' of a performance measure/mark, it will ignore that event */
